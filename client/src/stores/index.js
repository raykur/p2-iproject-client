  ...
  actions: {
    gachaDigimon: async function () {
      try {
        const response = await axios({
          method: "put",
          url: "https://gachamon-2.herokuapp.com/user/gachaDigimon",
          headers: {
    ...
    piniaRegister: async function (username, email, password, referral) {
      try {
        const response = await axios({
          method: "post",
          url: "https://gachamon-2.herokuapp.com/register",
          data: {
            username,
            email,
            password,
    ...
    piniaLogin: async function (email, password) {
      try {
        ...
        const response = await axios({
          method: "post",
          url: "https://gachamon-2.herokuapp.com/login",
          data: {
            email,
            password,
          },
    ...
    fetchReferralData: async function () {
      try {
        const response = await axios({
          method: "get",
          url: "https://gachamon-2.herokuapp.com/user/referralCode",
          headers: {
            access_token: localStorage.getItem("access_token"),
          },
        });
    ...
    fetchGachaCoin: async function () {
      try {
        const response = await axios({
          method: "get",
          url: "https://gachamon-2.herokuapp.com/user/gachaCoin",
          headers: {
            access_token: localStorage.getItem("access_token"),
          },
        });
    ...
    fetchListDigimon: async function () {
      try {
        const response = await axios({
          method: "get",
          url: "https://gachamon-2.herokuapp.com/digimonList",
        });
    ...
    fetchPaymentToken: async function () {
      try {
        const response = await axios({
          method: "get",
          url: "https://gachamon-2.herokuapp.com/user/paymentToken",
          headers: {
            access_token: localStorage.getItem("access_token"),
          },
        });
        ...
        this.userToken = response.data.transactionToken;
      } catch (err) {
        console.log(err);
      }
    },
    fetchListMyDigimon: async function () {
      try {
        ...
        const response = await axios({
          method: "get",
          url: "https://gachamon-2.herokuapp.com/user/myDigimon",
          headers: {
            access_token: localStorage.getItem("access_token"),
          },
        });
    ...
    piniaSellDigimon: async function (myDigimonId) {
      try {
        const response = await axios({
          method: "put",
          url: `https://gachamon-2.herokuapp.com/user/sellDigimon/${myDigimonId}`,
          headers: {
            access_token: localStorage.getItem("access_token"),
          },
        });
